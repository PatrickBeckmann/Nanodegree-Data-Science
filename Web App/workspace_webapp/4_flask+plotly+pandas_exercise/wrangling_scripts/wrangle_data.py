...
# fourth chart shows rural population vs arable land
    ...
    df = cleandata('data/API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv', keepcolumns, valuevariables)
    df.columns = ['country', 'year', 'percentrural']
    df.sort_values('percentrural', ascending=False, inplace=True)
    df = df[df['year'] == 2015] 
    ...
    layout_five = dict(title = 'Rural population in various countries in 2015',
                xaxis = dict(title = 'Country',),
